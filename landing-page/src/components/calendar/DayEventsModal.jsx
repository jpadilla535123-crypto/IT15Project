...
export default function DayEventsModal({ date, list, onClose, onSelect }) {
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md max-h-[80vh] overflow-y-auto no-scrollbar rounded-2xl border border-gray-200 dark:border-[#2A2A36] bg-white dark:bg-[#121217] p-5 shadow-2xl animate-fade-in">
