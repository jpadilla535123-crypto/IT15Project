    ...
    <div className="min-h-screen bg-[#0B0B0E]">
          ...
          <div className="hidden md:flex items-center gap-3">
            {user ? (
              ...
              <>
                ...
                <button onClick={() => setShowSignIn(true)} className="btn-primary text-sm !px-5 !py-2.5">Get A Ticket</button>
              </>
            )}
          </div>
            ...
            <div className="pt-4 border-t border-[#2A2A36]/50 flex flex-col gap-3">
              {user ? (
                ...
                <>
                  ...
                  <button onClick={() => { setShowSignIn(true); setMobileOpen(false) }} className="btn-primary text-center">Get A Ticket</button>
                </>
              )}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto relative rounded-3xl overflow-hidden bg-[#0B0B0E]">
          ...
          <div className="relative flex flex-col md:flex-row justify-between items-center gap-8 px-8 py-16 md:px-16">
            ...
            <div className="flex items-center gap-3 mt-6 md:mt-0 shrink-0">
              <a href="#" className="bg-[#FF2B66] hover:opacity-90 text-white text-sm font-semibold rounded-full px-6 py-2.5 transition">
                Get Started
              </a>
              <a href="#" className="border border-[#3A3A46] bg-transparent hover:bg-white/5 text-white text-sm font-semibold rounded-full px-6 py-2.5 transition">
                Talk to Sales
              </a>
            </div>
          </div>
      ...
      <footer className="bg-[#08080A]">
        <div className="max-w-7xl mx-auto px-8 py-12">
          ...
          {/* Newsletter Row */}
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 pb-12 border-b border-[#2A2A36]">
            <div className="flex flex-col items-start text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-12">
            ...
            <div className="flex flex-col text-left">
              ...
              <div className="flex flex-col space-y-3 text-sm text-[#D1D5DB]">
                {['Dashboard', 'Events', 'Schedules', 'Tickets', 'Analytics'].map(l => (
